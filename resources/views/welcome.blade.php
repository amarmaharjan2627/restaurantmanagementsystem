            ...
            <div class="container-fluid color-bg">
                <div class="row dis-table">
                    ...
                    <div class="col-xs-6 col-sm-6 dis-table-cell">
                        <div class="section-content">
                            <p>Khokana-21, Lalitpur, Nepal</p>
                            <p>+977-9849181966</p>
                            <p>amar.maharjan410@mail.com </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="#">Mama's Kitchen.</a> Developed by <a href="https:://github ko link" target="_blank">Amar Maharjan</a>
                            </p>
                        </div>
                    </div>
                </div>
